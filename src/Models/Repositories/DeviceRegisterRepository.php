...
class DeviceRegisterRepository extends Repository
{
    use FormTrait;
    use RepositoryTrait;
    ...
    {
        $this->instance = App::make(config('wk-core.class.device-sensor.deviceRegister'));
    }
