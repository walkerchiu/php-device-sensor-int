...
use WalkerChiu\DeviceSensor\Models\Forms\DeviceStateFormRequest;

class DeviceStateFormRequestTest extends \Orchestra\Testbench\TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->request  = new DeviceStateFormRequest();
     ...
     *
     * For WalkerChiu\DeviceSensor\Models\Forms\DeviceStateFormRequest
     * 
     * @return void
     */
