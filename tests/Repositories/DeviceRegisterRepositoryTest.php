...
use WalkerChiu\DeviceSensor\Models\Repositories\DeviceRegisterRepository;

class DeviceRegisterRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(DeviceRegisterRepository::class);
    }
    ...
    /**
     * A basic functional test on DeviceRegisterRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testDeviceRegisterRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on DeviceRegisterRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceSensor\Models\Repositories\DeviceRegisterRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(DeviceRegisterLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on DeviceRegisterRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceSensor\Models\Repositories\DeviceRegisterRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        factory(Device::class)->create();
        factory(DeviceRegister::class)->create(['is_enabled' => 1]);
        factory(DeviceRegister::class, 3)->create();
    ...
    /**
     * Unit test about Query List on DeviceRegisterRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceSensor\Models\Repositories\DeviceRegisterRepository
     *
    ...
    public function testQueryList()
    {
        ...
        // Give
        factory(Device::class)->create();
        factory(DeviceRegister::class, 4)->create();
    ...
    /**
     * Unit test about FormTrait on DeviceRegisterRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceSensor\Models\Repositories\DeviceRegisterRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            // Give
            factory(Device::class)->create();
            factory(DeviceRegister::class, 2)->create();
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => DeviceRegister::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => DeviceRegister::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(DeviceRegister::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(DeviceRegister::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(DeviceRegister::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    /**
     * Unit test about Auto Complete on DeviceRegisterRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceSensor\Models\Repositories\DeviceRegisterRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Device::class)->create();
        factory(DeviceRegister::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(DeviceRegister::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => DeviceRegister::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => DeviceRegister::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => DeviceRegister::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => DeviceRegister::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => DeviceRegister::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => DeviceRegister::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
